...
import { concurrency } from 'memfs/lib/thingies/concurrency';
import { flagsToNumber } from 'memfs/lib/node/util';
...
import type { IWriteStream } from 'memfs/lib/node/types/misc';
import type { IWriteStreamOptions } from 'memfs/lib/node/types/options';
